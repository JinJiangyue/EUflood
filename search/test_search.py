...
使用方法：
    ...
    # 处理指定的事件ID
    python search/test_search.py --event-id "20251011_Valencia/València_1"

    # 处理指定的事件ID（不更新数据库，仅测试）
    python search/test_search.py --event-id "20251011_Valencia/València_1" --dry-run
"""
...
def main():
    ...
    if args.json:
        ...
        try:
            ...
            # 保存报告到文件
            output_dir = project_root / "search_outputs"
